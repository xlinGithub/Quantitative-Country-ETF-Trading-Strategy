...
def initialize(context):
    url = 'https://raw.githubusercontent.com/xlinGithub/Quantitative-Country-ETF-Trading-Strategy/9be718b4125d7f33e691b91693486884cfe91f0f/backtest_inputs.csv'
    fetch_csv(url, 
              date_column='Date',
              pre_func = preview,
              date_format='%Y-%m-%d')
